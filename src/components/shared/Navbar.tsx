...
export interface NavbarProps {
  ...
  links?: NavLink[]
  /** Signed-in user shown in the profile menu. */
  user?: NavUser
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md supports-backdrop-filter:bg-background/60">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            {/* {brand} */}
            <Image src={logo} alt="TDN - The Daily Narrative - Blogging platform for everyone" width={50} height={40}/>
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" showCloseButton={false} className="flex w-72 flex-col gap-0 p-0">
